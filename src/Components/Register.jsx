                ...
                <Form onSubmit={this.submitPost}>
                  ...
                  <FormGroup>
                    ...
                    <Input
                      ...
                      required
                    ></Input>
                    {errorMessage.type === "USERNAME_EXIST" && (
                  ...
                  <FormGroup>
                    ...
                    {this.state.password &&
                      ...
                      this.state.password !== this.state.confirmPassword && (
                        <div class="error">The password does not match</div>
                      )}
                  </FormGroup>
                  <FormGroup>
                    <Label>E-Mail</Label>
  ...
  submitPost = async (e) => {
    ...
    try {
      let response = await fetch(
        "https://appcademix-be.cyclic.app/api/auth/register",
        {
          method: "POST",
          headers: {
      ...
      } else toast.error("oops somethimg went wrong");
